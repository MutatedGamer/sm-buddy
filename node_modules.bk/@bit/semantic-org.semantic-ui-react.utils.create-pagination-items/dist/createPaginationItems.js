...
var createPaginationItems = function createPaginationItems(rawOptions) {
  ...
  return [(0, _itemFactories.createFirstPage)(), (0, _itemFactories.createPrevItem)(activePage)].concat(_toConsumableArray(innerRange), [(0, _itemFactories.createNextItem)(activePage, totalPages), (0, _itemFactories.createLastItem)(totalPages)]);
};

exports.default = createPaginationItems;

//# sourceMappingURL=createPaginationItems.js.map